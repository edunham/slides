...
\def\slidesurl{\url{http://talks.edunham.net/osulug2019}}
\def\talkdate{March 5, 2017}
% ???
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item Community (prefers inclusion over intolerance)
    \end{itemize}
\end{frame}
...
\begin{frame}[fragile]
    Spaces only matter when separating tokens:
