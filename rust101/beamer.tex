...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item \begin{verbatim} rustup install nightly\end{verbatim}
        \item \begin{verbatim} rustup run nightly cargo new\end{verbatim}
    \end{itemize}
\end{frame}
...
\begin{frame}[fragile]
    Functions:
    \begin{itemize}
        %\item \begin{verbatim} fn myfunction { ... } \end{verbatim}
        %\item \begin{verbatim} fn myfunction (arg: type, arg: type) -> resulttype { ... } \end{verbatim}
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item \begin{verbatim} macroname!(foo, bar, baz) \end{verbatim}
        \item \url{https://doc.rust-lang.org/beta/book/macros.html}
    \end{itemize}
\end{frame}
...
\begin{frame}
    Ownership:
    \begin{itemize}
        \item \begin{verbatim} let myint = 42; \end{verbatim}
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item \begin{verbatim} let mut myint = 42; \end{verbatim}
    \end{itemize}
\end{frame}
...
\begin{frame}
    ...
    \begin{itemize}
        \item \begin{verbatim} cargo new --bin \end{verbatim}
            \begin{itemize}
                \item Binary
                \item You run main.rs
                \item cargo.lock stores state of last good build
            \end{itemize}
        \item \begin{verbatim} cargo new \end{verbatim}
            \begin{itemize}
                \item Library
